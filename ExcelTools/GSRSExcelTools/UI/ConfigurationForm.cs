...
namespace GSRSExcelTools.UI
{
    public partial class ConfigurationForm : Form
    {
        ...
        private void DisplayCurrentConfiguration()
        {
            ...
            textBoxScriptDelay.Text = CurrentConfiguration.PageBuildDelayMilliseconds.ToString();
        }
        ...
        private void buttonOK_Click(object sender, EventArgs e)
        {
            ...
            if( Int32.TryParse(textBoxScriptDelay.Text, out int scriptDelayMilliseconds))
            {
                CurrentConfiguration.PageBuildDelayMilliseconds = scriptDelayMilliseconds;
            }
            else
            {
                log.WarnFormat("Unable to get a number from text box value {0}",
                    textBoxScriptDelay.Text);
            }
