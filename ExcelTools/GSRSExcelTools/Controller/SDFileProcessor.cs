...
namespace GSRSExcelTools.Utils
{
    public class SDFileProcessor : ControllerBase, IController
    {
        ...
        public const string SD_LOADING_SCRIPT_NAME = "Create Substance from SD File";
        internal const string DEFAULT_SUBSTANCE_TYPE = "chemical";
        public const string FIELD_NAME_UNIQUENESS = "Uniqueness";
        ...
        public async Task<object> HandleResults(string resultsKey, string message)
        {
            ...
            if (Callbacks.Count == 0)
            {
                ...
                await ManageSetupRemainingColumns();
                return true;
            }
            else
            {
        ...
        public async Task ManageSetupRemainingColumns()
        {
