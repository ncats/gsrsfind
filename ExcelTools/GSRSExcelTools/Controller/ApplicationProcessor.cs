...
using Application = GSRSExcelTools.Model.FDAApplication.Application;
...
namespace GSRSExcelTools.Controller
{
    public class ApplicationProcessor : ControllerBase, IController
    {
        ...
        public async Task<bool> StartResolution(bool newSheet)
        {
            ...
            await scriptUtils.BuildScriptParameters(scriptParameters.Keys);
        ...
        private async void StartVocabularyRetrievals()
        {
            ...
            scriptUtils.ScriptExecutor = ScriptExecutor;
            await scriptUtils.StartVocabularyRetrievals(vocabularyNames);
        }

        public async override void CompleteSheet()//unfortunate name
        {
            log.Debug("Calling StartResolution");
            await StartResolution(false);
        }
