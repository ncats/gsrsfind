...
namespace GSRSExcelTools.Controller
{
    ...
    public class ApplicationSheetCreator : ControllerBase, IController
    {
        ...
        public void ContinueSetup()
        {
            ...
            _=scriptUtils.StartVocabularyRetrievals(fieldsWithVocabs.Select(f => f.VocabularyName).ToList());
        }
        ...
        public Task<bool> StartResolution(bool newSheet)
        {
        ...
        public async Task ResolveIngredients(List<Range> ingredients)
        {
